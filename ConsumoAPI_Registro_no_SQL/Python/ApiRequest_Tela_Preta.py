...
class App:
    def __init__(self, root):
        ...
        self.url_entry.insert(0, "https://apiv3.vexsoft.com.br/vistoria/axn105")
        ...
        self.server_entry.insert(0, '18.229.225.139')
        ...
        self.database_entry.insert(0, 'BMCLIENTES')
        ...
        self.username_entry.insert(0, 'api_vex')
        ...
        self.password_entry.insert(0, 'hexagon@vex')
    ...
    def registra_campos_dinamicos(self, conn, table_name, tabela_nova,num_requests): 
        ...
        if resultados:
            ...
            self.log("Nenhum resultado encontrado.")
